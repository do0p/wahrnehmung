...
public class RichTextToolbar extends Composite {
	...
	private void changeHtmlStyle(String startTag, String stopTag) {
		...
		this.styleText.setText(txbuffer.substring(0, startpos.intValue())
				+ startTag
				+ selectedText
				+ stopTag
				+ txbuffer.substring(startpos.intValue()
						+ selectedText.length()));
	}
	...
	private void buildTools() {
		this.topPanel.add(this.bold = createToggleButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(20),
				Integer.valueOf(20), "Bold"));
		this.topPanel.add(this.italic = createToggleButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(60), Integer.valueOf(20),
				Integer.valueOf(20), "Italic"));
		this.topPanel.add(this.underline = createToggleButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(140), Integer.valueOf(20),
				Integer.valueOf(20), "Underline"));
		this.topPanel.add(this.stroke = createToggleButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(120), Integer.valueOf(20),
				Integer.valueOf(20), "Stroke"));
		this.topPanel.add(new HTML("&nbsp;"));
		this.topPanel.add(this.subscript = createToggleButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(600), Integer.valueOf(20),
				Integer.valueOf(20), "Subscript"));
		this.topPanel.add(this.superscript = createToggleButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(620), Integer.valueOf(20),
				Integer.valueOf(20), "Superscript"));
		this.topPanel.add(new HTML("&nbsp;"));
		this.topPanel.add(this.alignleft = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(460), Integer.valueOf(20),
				Integer.valueOf(20), "Align Left"));
		this.topPanel.add(this.alignmiddle = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(420), Integer.valueOf(20),
				Integer.valueOf(20), "Align Center"));
		this.topPanel.add(this.alignright = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(480), Integer.valueOf(20),
				Integer.valueOf(20), "Align Right"));
		this.topPanel.add(new HTML("&nbsp;"));
		this.topPanel.add(this.orderlist = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(80), Integer.valueOf(20),
				Integer.valueOf(20), "Ordered List"));
		this.topPanel.add(this.unorderlist = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(20), Integer.valueOf(20),
				Integer.valueOf(20), "Unordered List"));
		this.topPanel.add(this.indentright = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(400), Integer.valueOf(20),
				Integer.valueOf(20), "Ident Right"));
		this.topPanel.add(this.indentleft = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(540), Integer.valueOf(20),
				Integer.valueOf(20), "Ident Left"));
		this.topPanel.add(new HTML("&nbsp;"));
		this.topPanel.add(this.generatelink = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(500), Integer.valueOf(20),
				Integer.valueOf(20), "Generate Link"));
		this.topPanel.add(this.breaklink = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(640), Integer.valueOf(20),
				Integer.valueOf(20), "Break Link"));
		this.topPanel.add(new HTML("&nbsp;"));
		this.topPanel.add(this.insertline = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(360), Integer.valueOf(20),
				Integer.valueOf(20), "Insert Horizontal Line"));
		this.topPanel.add(this.insertimage = createPushButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(380), Integer.valueOf(20),
				Integer.valueOf(20), "Insert Image"));
		this.topPanel.add(new HTML("&nbsp;"));
		this.topPanel.add(this.removeformatting = createPushButton(
				"/icons.gif", Integer.valueOf(20), Integer.valueOf(460),
				Integer.valueOf(20), Integer.valueOf(20), "Remove Formatting"));
		this.topPanel.add(new HTML("&nbsp;"));
		this.topPanel.add(this.texthtml = createToggleButton("/icons.gif",
				Integer.valueOf(0), Integer.valueOf(260), Integer.valueOf(20),
				Integer.valueOf(20), "Switch View HTML/Source"));
	...
	private class EventHandler implements ClickHandler, KeyUpHandler,
		...
		public void onClick(ClickEvent event) {
			if (event.getSource().equals(RichTextToolbar.this.bold)) {
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					RichTextToolbar.this.changeHtmlStyle(
				...
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					...
					RichTextToolbar.this.superscript)) {
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
				...
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					...
					RichTextToolbar.this.alignmiddle)) {
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					RichTextToolbar.this.changeHtmlStyle(
					...
					.equals(RichTextToolbar.this.alignright)) {
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					RichTextToolbar.this.changeHtmlStyle(
				...
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					RichTextToolbar.this.changeHtmlStyle("<ol><li>",
							"</ol></li>");
				else
					RichTextToolbar.this.styleTextFormatter.insertOrderedList();
			} else if (event.getSource().equals(
					RichTextToolbar.this.unorderlist)) {
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					RichTextToolbar.this.changeHtmlStyle("<ul><li>",
							"</ul></li>");
				else
					RichTextToolbar.this.styleTextFormatter
							.insertUnorderedList();
			} else if (event.getSource().equals(
					RichTextToolbar.this.indentright)) {
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					RichTextToolbar.this.changeHtmlStyle(
					...
					.equals(RichTextToolbar.this.indentleft)) {
				if (!RichTextToolbar.this.isHTMLMode().booleanValue()) {
					RichTextToolbar.this.styleTextFormatter.leftIndent();
				}
			} else if (event.getSource().equals(
					RichTextToolbar.this.generatelink)) {
				String url = Window.prompt("Enter a link URL:", "http://");
				if (url != null) {
					if (RichTextToolbar.this.isHTMLMode().booleanValue())
						RichTextToolbar.this.changeHtmlStyle("<a href=\"" + url
								+ "\">", "</a>");
					else
				...
				if (!RichTextToolbar.this.isHTMLMode().booleanValue()) {
					...
					RichTextToolbar.this.insertimage)) {
				String url = Window.prompt("Enter an image URL:", "http://");
				if (url != null) {
					if (RichTextToolbar.this.isHTMLMode().booleanValue())
						RichTextToolbar.this.changeHtmlStyle("<img src=\""
								+ url + "\">", "");
					else
						RichTextToolbar.this.styleTextFormatter
								.insertImage(url);
					...
					.equals(RichTextToolbar.this.insertline)) {
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					RichTextToolbar.this.changeHtmlStyle(
					...
					RichTextToolbar.this.removeformatting)) {
				if (!RichTextToolbar.this.isHTMLMode().booleanValue()) {
				...
				if (RichTextToolbar.this.texthtml.isDown())
					RichTextToolbar.this.styleText
							.setText(RichTextToolbar.this.styleText.getHTML());
				else
					RichTextToolbar.this.styleText
							.setHTML(RichTextToolbar.this.styleText.getText());
			} else {
		...
		public void onChange(ChangeEvent event) {
			if (event.getSource().equals(RichTextToolbar.this.fontlist)) {
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					RichTextToolbar.this
							.changeHtmlStyle(
									"<span style=\"font-family: "
											+ RichTextToolbar.this.fontlist
													.getValue(RichTextToolbar.this.fontlist
															.getSelectedIndex())
											+ ";\">", "</span>");
				else
					RichTextToolbar.this.styleTextFormatter
							.setFontName(RichTextToolbar.this.fontlist
									.getValue(RichTextToolbar.this.fontlist
											.getSelectedIndex()));
				...
				if (RichTextToolbar.this.isHTMLMode().booleanValue())
					RichTextToolbar.this
							.changeHtmlStyle(
									"<span style=\"color: "
											+ RichTextToolbar.this.colorlist
													.getValue(RichTextToolbar.this.colorlist
															.getSelectedIndex())
											+ ";\">", "</span>");
				else
					RichTextToolbar.this.styleTextFormatter
							.setForeColor(RichTextToolbar.this.colorlist
									.getValue(RichTextToolbar.this.colorlist
											.getSelectedIndex()));
		}
	}
